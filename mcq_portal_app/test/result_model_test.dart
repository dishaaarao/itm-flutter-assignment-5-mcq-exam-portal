...
void main() {
  ...
  group('AttemptRow', () {
    test('carries the snapshotted exam title and the auto-submit flag', () {
      final row = AttemptRow.fromJson({
        ...
        'examTitle': 'Midterm',
        'studentId': 's1',
        'studentName': 'Disha Rao',
        'studentEmail': 'disha@example.com',
        'status': 'submitted',
        'autoSubmitted': true,
        'score': 17.5,
        'totalMarks': 40,
  ...
  group('AppUser', () {
    test('initials come from the first two words', () {
      expect(
        const AppUser(id: '1', name: 'Disha Rao', email: 'a@b.c', role: 'student').initials,
        'DR',
      );
      expect(
        const AppUser(id: '1', name: 'Disha', email: 'a@b.c', role: 'student').initials,
        'D',
      );
      expect(
    ...
    test('reads the aggregate and its rows', () {
      final report = ExamReport.fromJson({
        ...
        'summary': {
          ...
          'lowestScore': 12.5,
          'passPercentage': 50,
          'topper': {'studentName': 'Disha Rao', 'score': 30},
        },
        'rows': [
          {
            'attemptId': 'a1',
